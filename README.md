# Healthcare AI Adoption — Fictional 30-60-90 Day Project Portfolio
...
1. `01-project-charter.md` — scope, objectives, sponsor, success criteria
2. `02-30-60-90-day-plan.md` — phased plan with milestones, owners, exit criteria
3. `03-raid-log.md` — Risks, Assumptions, Issues, Dependencies
...
- The 30-60-90 plans assume a mid-size org, one workstream lead per function, and a single PM running all three phases.
